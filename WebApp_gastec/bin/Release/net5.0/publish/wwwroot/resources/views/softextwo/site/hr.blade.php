        ...
        <div class="inner-container clearfix">
            <?php if(\App\System::getCookies()=="ar"){ ?>
                <ul class="bread-crumb pull-right">
                    ...
                    <li><a href="<?=env('APP_URL')?>aboutus">عن غازتك</a></li>
                    <li>{{ $linktitle }}</li>
                ...
                <?php }  elseif(\App\System::getCookies()=="en"){ ?> 
                    ...
                    <li><a href="<?=env('APP_URL')?>aboutus">About Us</a></li>
       ...
       <?php } ?>	
                	<aside class="sidebar">
                        ...
                        <!--Blog Category Widget-->
                         ...
                         <?php
                              \App\System::getModule("sidenav",$linkclass."/".$linkid,"#sidenavelist","<div class='linear-background'></div>");
