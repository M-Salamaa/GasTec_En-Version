                	...
                	<aside class="sidebar">
                        ...
                        <div class="sidebar-widget sidebar-blog-category">
                            <ul class="blog-cat">
                                ...
                                <li class="active"><a href="{{ env('APP_URL') }}mediafiles">تقارير ومطبوعات </a></li>
                            </ul>
                        </div>
...
<aside class="sidebar">
                        ...
                        <div class="sidebar-widget sidebar-blog-category">
                            <ul class="blog-cat">
                                ...
                                <li class="active"><a href="{{ env('APP_URL') }}mediafiles">Reports & Print outs </a></li>
       ...
       <?php } ?>
						<div class="inner-box">
                                                    ...
                                                    <div id="filesholder"></div>
                                                     <?php
                            \App\System::getModule("filestempone","0","#filesholder","<div class='linear-background'></div>");
                            ?>
