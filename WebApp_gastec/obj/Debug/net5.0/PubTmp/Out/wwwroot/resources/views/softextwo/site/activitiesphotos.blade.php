       ...
       <?php if(\App\System::getCookies()=="ar"){ ?>
                	<aside class="sidebar">
                        ...
                        <div class="sidebar-widget sidebar-blog-category">
                            <ul class="blog-cat">
                                <li><a href="{{ env('APP_URL') }}media_center">أحدث الأخبار</a></li>
                                <li><a href="{{ env('APP_URL') }}imggallery">معرض الصور</a></li>
                                <li><a href="{{ env('APP_URL') }}videos">فيديوهات </a></li>
                                <li class="active"><a href="{{ env('APP_URL') }}activitiesphotos">صور الأنشطة </a></li>
...
<aside class="sidebar">
                        ...
                        <div class="sidebar-widget sidebar-blog-category">
                            <ul class="blog-cat">
                                <li><a href="{{ env('APP_URL') }}media_center">Latest News</a></li>
                                <li><a href="{{ env('APP_URL') }}imggallery">Image Gallery</a></li>
                                <li><a href="{{ env('APP_URL') }}videos">Videos </a></li>
                                <li class="active"><a href="{{ env('APP_URL') }}activitiesphotos">Activities Photos </a></li>
...
<?php } ?>
                ...
                <div class="content-side pull-left col-lg-9 col-md-8 col-sm-12 col-xs-12">
                            ...
                            <div class="auto-container">
                                ...
                                <div id="galrow"></div>
                                <?php
                            \App\System::getModule("galtemptwo","activity","#galrow","<div class='linear-background'></div>");
                            ?>
                </div>
