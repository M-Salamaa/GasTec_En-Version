                	...
                	<aside class="sidebar">
                        ...
                        <div class="sidebar-widget sidebar-blog-category">
                            <ul class="blog-cat">
                                ...
                                <li class="active"><a href="{{ env('APP_URL') }}imggallery">معرض الصور</a></li>
...
<aside class="sidebar">
                        ...
                        <div class="sidebar-widget sidebar-blog-category">
                            <ul class="blog-cat">
                                ...
                                <li class="active"><a href="{{ env('APP_URL') }}imggallery">Image Gallery</a></li>
...
<?php } ?>
                ...
                <div class="content-side pull-left col-lg-9 col-md-8 col-sm-12 col-xs-12">
                            ...
                            <div class="auto-container">
                                ...
                                <div id="galrow"></div>
                                <?php
                            \App\System::getModule("galtemptwo","event","#galrow","<div class='linear-background'></div>");
                            ?>
                </div>
