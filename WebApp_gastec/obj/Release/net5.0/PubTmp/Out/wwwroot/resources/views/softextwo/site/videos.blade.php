                	...
                	<aside class="sidebar">
                        ...
                        <div class="sidebar-widget sidebar-blog-category">
                            <ul class="blog-cat">
                                ...
                                <li class="active"><a href="{{ env('APP_URL') }}videos">فيديوهات </a></li>
...
<aside class="sidebar">
                        ...
                        <div class="sidebar-widget sidebar-blog-category">
                            <ul class="blog-cat">
                                ...
                                <li class="active"><a href="{{ env('APP_URL') }}videos">Videos </a></li>
       ...
       <?php } ?>	
						<div class="inner-box">
                                                    ...
                                                    <div id="videoholder"></div>
                                                     <?php
                            \App\System::getModule("vidtempone","32700","#videoholder","<div class='linear-background'></div>");
                            ?>
