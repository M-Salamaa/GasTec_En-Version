...
$linkimg=\App\System::HtmlImgCache($linkimg);
    ...
    <div class="sidebar-page-container">
       ...
       <?php } ?>	
                	<aside class="sidebar">
                        ...
                        <!--Blog Category Widget-->
                         ...
                         <?php
                              \App\System::getModule("sidenav",$linkclass."/".$linkid,"#sidenavelist","please wait..",0);
       ...
       <div class="inner-box">
                            ...
                            <div id="cmspage1"></div>  
                                                         <?php
                                                         if(isset($_GET["html"])){
                                                            \App\System::getModule("pagetempone",$_GET["html"],"#cmspage1","<div class='linear-background'></div>",0);
                	...
                	<div class="inner-column">
                    	<div class="row clearfix">
                            ...
                            if($linkimg!=""){
                             ...
                             <div id="teambox"></div>
                            <?php
                            \App\System::getModule("galtempone",$linkimg,"#teambox","please wait..");
                            }
                            ?>
