            ...
            <table class="table table-bordered" id="dataTable" width="100%" cellspacing="0">
                ...
                <tbody>
					...
					<?php }else{ ?>
					 <tr>
                        <td>Location Image</td>
                        <td><input type="text" name="proimage[]" value="" class="form-control form-control-user" placeholder="proimage"></td>
                    </tr>
					<?php } ?>
                    <tr>
                        <td>Marker Icon</td>
